...
// Patched for WeChat Mini Program: the sandboxed JS runtime has no Node
// `perf_hooks` module, and its require() throws (rather than failing softly)
// when a module isn't found -- unlike Node, where this require() would still
// have succeeded. Use whatever global `performance` object the runtime
// provides (if any); the fallback below already covers the case where it's
// missing or lacks `.now()`.
const performance = (typeof globalThis !== 'undefined' && globalThis.performance) || (typeof global !== 'undefined' && global.performance) || {};
